      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">FarmSchemes</span>
            </div>
            <p className="mt-2 text-sm text-gray-600">
              Connecting farmers with government aid programs for sustainable agriculture.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-6">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} FarmSchemes. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
